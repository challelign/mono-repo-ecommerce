...
const ProductInteraction = ({
  ...
  const handleTypeChange = (type: string, value: string) => {
    ...
    // router.push(`${pathname}?${params.toString()}`, { scroll: false });
      router.replace(`${pathname}?${params.toString()}`, { scroll: false }); //doesn’t reset scroll or reload component tree
  ...
  return (
    <div className="flex flex-col gap-4 mt-4">
      ...
      <button
        ...
        className="w-full mt-4 px-5 py-2 rounded-md bg-amber-600 text-white hover:bg-amber-700 transition-colors duration-300 flex items-center justify-center gap-2 cursor-pointer"
